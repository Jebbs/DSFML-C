...
// Destroy a window
DSFML_WINDOW_API void sfWindow_destroy(void* window);


//Close a window and destroy all the attached resources
DSFML_WINDOW_API void sfWindow_close(void* window);


//Tell whether or not a window is opened
DSFML_WINDOW_API DBool sfWindow_isOpen(const void* window);
