...
public:
	...
	sfSoundStreamImp(DUint channelCount, DUint sampleRate, SoundStreamCallBacks* newCallBacks)
	{
...
{
	sfSoundStream(DUint channelCount, DUint sampleRate, SoundStreamCallBacks* newCallBacks):
	This(channelCount, sampleRate, newCallBacks)
	{
